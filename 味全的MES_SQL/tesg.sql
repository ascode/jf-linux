USE [MES] GO /****** Object: View [dbo].[ProVGreRptSiltingStop] Script Date: 2018/8/16 18:30:35 ******/ SET ANSI_NULLS
    ON GO SET QUOTED_IDENTIFIER
    ON GO CREATE VIEW [dbo].[ProVGreRptSiltingStop] ASSELECT ISNULL(a.SchedulNO,
...
WHERE LEN(stop.StopTime)>0
        ...
        AND LEN(Stop.ID)>0
        AND DATEDIFF(Minute ,stop.StopTime ,Stop.StartTime)>0 GO 